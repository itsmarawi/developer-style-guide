# ITSMarawi Vue Developer Style Guide
...
These rules help prevent errors, so learn and abide by them at all costs. Exceptions may exist, but should be very rare and only be made by those with expert knowledge of both JavaScript, TypeScript and Vue.
...
Detailed Prop Definition have two advantages:
...
``` ts
expor class TodoListComponent extends Vue { }

expor class TodoItemComponent extends Vue { }
```
