...
> ITSMarawi unofficial TypeScript Style Guide
...
* **Don't** postfix with `Interface`
* *[Optional]* prefix with `I`.
...
## Filename
Name files with `kebab-space` or `PascalCase` and ends with component or module type before extension. E.g. `accordion.component.vue`, `DashboardPage.vue`, `api.service.ts`, `person.module.ts` etc.
